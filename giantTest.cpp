...
void runScenario(const std::string &scenarioName, const std::vector<std::function<void()>> &threads)
{
    ...
    logFile << scenarioName << " - Total accesses: " << drd.numAccesses << "\n";
    logFile << scenarioName << " - Total lock acquisitions: " << drd.numLockAcquisitions << "\n";
    logFile << scenarioName << " - Total lock releases: " << drd.numLockReleases << "\n";
    logFile << scenarioName << " - Total data races detected: " << drd.numDataRaces << "\n";
...
int main()
{
    ...
    logFile << "Total accesses: " << drd.numAccesses << "\n";
    logFile << "Total lock acquisitions: " << drd.numLockAcquisitions << "\n";
    logFile << "Total lock releases: " << drd.numLockReleases << "\n";
    logFile << "Total data races detected: " << drd.numDataRaces << "\n";
